...
import { ArrowLeft, RefreshCw, Cpu, MemoryStick, HardDrive, Clock, Terminal, Box, Activity } from 'lucide-react';
...
function MachineDetail({ machine, onBack, onRefresh }) {
    ...
    <div className="machine-detail animate-in">
      <div className="detail-header">
        ...
        <div className="detail-title-row">
          ...
          <div>
            <h2 className="detail-name">{machine.name || machine.hostname || machine.ip}</h2>
      ...
      <div className="detail-grid">
        ...
        {/* Agents / Containers */}
        <div className="detail-section glass">
          <h3><Box size={14} /> Agenten / Container</h3>
          {machine.agents?.length > 0 ? (
            ...
            <div className="empty-state">Keine Agenten gefunden</div>
          )}
        </div>
